...
namespace TINEXPRESSAPIS.UserMgmtAPI.Controllers
{
    ...
    public class UserLoginsController : ControllerBase
    {
        ...
        public UserLoginsController(IUserLoginsService userLoginsService, IJwtTokenService jwtTokenService, IUserProfileService userProfileService)
        {
        ...
        public async Task<IActionResult> Login([FromBody] Application.DTOs.LoginRequest request)
        {
            ...
            var user = await _userLoginsService.GetByEmailandPassword(request.Email, request.Password);
            if (user != null)
            {
        ...
        public async Task<IActionResult> SocialLogin([FromBody] SocialLoginRequest request)
        {
            ...
            var checkUser = await _userLoginsService.GetByEmaila(socialData.email);
            if (checkUser == null)
            {
                try
                {
            ...
            var user = await _userLoginsService.GetByEmailandPassword(socialData.email, "");
