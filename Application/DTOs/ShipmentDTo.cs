...
{
    //public record shipmentDto(string? consignment_number, string? order_number, string? sender_name, string? sender_email,
    ...
    //    string? unit_num_dropoff, string? street_number_dropoff, string? street_dropoff, string? suburb_dropoff, string? postcode_dropoff,
    ...
    //{
    //    //public int OrderSource { get; set; } = int.;
    //    //public int Option { get; set; } = string.Empty;
